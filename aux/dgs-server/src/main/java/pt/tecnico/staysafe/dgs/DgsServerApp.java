...
public class DgsServerApp {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		final BindableService impl2 = new DgsServiceImpl();
		...
		try {
			...
			Server server2 = ServerBuilder.forPort(portStr2).addService(impl2).build();
			...
			ServersFrontend frontend1 = new ServersFrontend(zkNaming,path,0);
			ServersFrontend frontend2 = new ServersFrontend(zkNaming,path2,1);
