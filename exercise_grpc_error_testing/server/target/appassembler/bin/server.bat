...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="server" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.tecnico.testing.TestingServerApp %CMD_LINE_ARGS%
