...
public class TTTGame {
	...
	private ArrayList<char[][]> boardPlays = new ArrayList<char[][]>();
	...
	public PlayResult undoThe2LatestMoves() {
		if(numPlays == 0) {
			return PlayResult.SUCCESS;
		} else if (numPlays <= 2) {
			resetBoard();
			...
			board=boardPlays.get(numPlays -2);
			boardPlays.remove(numPlays);
			boardPlays.remove(numPlays -1);
			numPlays-=2;
			return PlayResult.SUCCESS;
